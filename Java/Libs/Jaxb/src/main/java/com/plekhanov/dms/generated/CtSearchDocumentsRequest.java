...
/**
 * Запрос поиска документов по параметрам
 * 
 * <p>Java class for ct_SearchDocumentsRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ct_SearchDocumentsRequest">
 *   &lt;complexContent>
 ...
 *         &lt;element name="returnFields" type="{http://www.raiffeisen.ru/types/CustomField/v1}ct_CustomFieldList" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ct_SearchDocumentsRequest", namespace = "http://www.raiffeisen.ru/esb/cnr/RBP/Document/v1", propOrder = {
    "identificators",
    "document",
    "returnFields"
})
public class CtSearchDocumentsRequest {
    ...
    protected CtCustomFieldList returnFields;
     ...
     *     
     */
    public CtCustomFieldList getReturnFields() {
        return returnFields;
    }
     ...
     *     
     */
    public void setReturnFields(CtCustomFieldList value) {

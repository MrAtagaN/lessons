...
/**
 *  Результат Изменения документа
 * 
 * <p>Java class for ct_UpdateProfileResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ct_UpdateProfileResponse">
 *   &lt;complexContent>
...
@XmlType(name = "ct_UpdateProfileResponse", namespace = "http://www.raiffeisen.ru/esb/cnr/RBP/Document/v1", propOrder = {
    "document"
})
public class CtUpdateProfileResponse {
